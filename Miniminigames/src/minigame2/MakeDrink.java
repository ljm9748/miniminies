...
public class MakeDrink {
	...
	/*
	 ...
	 그러나 아메리카노에 포함된 요소를 물 , 커피, 없음 이 꼭 들어가야하늗네
	 없음 , 없음, 없음 을 입력해도 아메리카노가 완성됨..!?
	
	 2020 11 03 Ver0.3 해결내용
	 contains 는 띄어쓰기마다 포함된 요소인지 비교를 한다.
	 "물 커피 없음" 는 "물" "커피" "없음" 을 나타낸다 그래서 var1,2,3에 
	  커피 커피 커피 를 넣어도 true값이 반환되었다.
	 "물커피없음" 은 "물커피없음"을 나타낸다.
	  플레이어가 입력한 var1,2,3을 더 해서 String을 만들고 띄어쓰기로 경우의수를 구분해 적어서 비교하기로했다.
	  레시피용 String은 늘어났으나 삼항연산자를 줄여 가독성이 좋아졌다!
	*/
	
	String americano = "물커피없음 물없음커피 없음커피물 없음물커피 커피없음물 커피물없음";
	String cafeLatte = "우유커피없음 우유없음커피 없음커피우유 없음우유커피 커피없음우유 커피우유없음";
