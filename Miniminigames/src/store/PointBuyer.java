...
public class PointBuyer extends Buyer {
	...
	// 생성자
	public PointBuyer(String id, int myMoney, int myPoint, int getPoint) {
		super(id, myMoney, myPoint, getPoint);
	}

	PointBuyer(PointBuyer pointbuyer) {
		this(pointbuyer.getId(),  pointbuyer.getMyMoney(), pointbuyer.getGetPoint(), pointbuyer.getGetPoint());
	}
