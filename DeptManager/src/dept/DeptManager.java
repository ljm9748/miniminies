...
public class DeptManager {
	...
	// 부서 입력 메소드: 사용자에게 입력받은 데이터를 Dao를 이용해서 DB에 입력
	...
	// 부서 정보 수정 메소드: 사용자로부터 입력 받고 데이터를 Dao를 이용해서 수정
	void editDept() {
		System.out.println("수정을 원하는 부서 번호를 입력해주세요.");
		String deptno = sc.nextLine();
	...
	void delDept( ) {
		...
		if (resultCnt > 0) {
			...
			System.out.println("삭제하려는 정보가 존재하지 않습니다.");
		}
	} // void delDept()
